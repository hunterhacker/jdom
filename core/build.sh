...
LOCALCLASSPATH=${JAVA_HOME}/lib/tools.jar${PS}./lib/xerces.jar${PS}./lib/ant.jar${PS}./lib/xml-apis.jar${PS}$JAVA_HOME/lib/dev.jar${PS}./lib/jaxen-core.jar${PS}./lib/jaxen-jdom.jar${PS}./lib/saxpath.jar${PS}./build/classes
ANT_HOME=./lib

...
set LOCALCLASSPATH=%JAVA_HOME%\lib\tools.jar;..\jdom\lib\xerces.jar;.\lib\ant.jar;.\lib\jakarta-ant-1.3-optional.jar;..\jdom\build\jdom.jar;..\jdom-contrib\build\classes;.\lib\junit.jar
set ANT_HOME=./lib
